...
/**
 * A DTO for the GearFiles entity.
 */
public class GearFilesDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        GearFilesDTO gearFilesDTO = (GearFilesDTO) o;
        if (gearFilesDTO.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), gearFilesDTO.getId());
    }
