...
@Component({
    ...
    animations: [
        trigger('sidenavState', [
            ...
            transition(`${SidenavState.CollapsedHover} => ${SidenavState.Collapsed}`, [animate('300ms cubic-bezier(.35, 0, .25, 1)')]),
            transition(`${SidenavState.Collapsed} => ${SidenavState.CollapsedHover}`, animate('300ms cubic-bezier(.35, 0, .25, 1)')),
...
export class SidenavComponent implements OnInit, OnDestroy {
    ...
    constructor(private router: Router, private sidenavService: SidenavService, private cd: ChangeDetectorRef) {}
    ...
    ngOnInit() {
        ...
        this.sidenavService.sidenavState$.pipe(takeUntil(componentDestroyed(this))).subscribe(sidenavState => {
