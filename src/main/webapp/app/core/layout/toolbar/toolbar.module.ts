...
import { ToolbarUnitComponent } from './toolbar-unit/toolbar-unit.component';
import { HasAuthorityDirective } from './has-authority.directive';

@NgModule({
    imports: [CommonModule, MaterialModule, RouterModule, ScrollbarModule, FormsModule, ClickOutsideModule, FuryCardModule],
    declarations: [
        ToolbarComponent,
        ...
        ToolbarUnitComponent,
        HasAuthorityDirective // para validar mostrar componentes deacuerdo al perfil
    ],
