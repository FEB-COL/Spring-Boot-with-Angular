...
@Component({
    ...
    templateUrl: './criteria-create-update.component.html',
    styleUrls: ['./criteria-create-update.component.scss']
})
export class CriteriaCreateUpdateComponent implements OnInit {
    ...
    constructor(
        ...
        private dialogRef: MatDialogRef<CriteriaCreateUpdateComponent>,
    ...
    ngOnInit() {
        ...
        if (this.defaults) {
            ...
            this.defaults = {} as IGearCriteria;
        }
