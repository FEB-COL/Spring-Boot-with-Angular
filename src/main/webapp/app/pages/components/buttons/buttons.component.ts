...
export class ButtonsComponent implements OnInit {
    flatButtonsHTML: string = escape(`<button mat-button>Button</button>
<button mat-button color="primary">Primary</button>
<button mat-button color="accent">Accent</button>
<button mat-button color="warn">Warn</button>
<button mat-button disabled="true">Disabled</button>`);

    raisedButtonsHTML: string = escape(`<button mat-raised-button>Button</button>
<button mat-raised-button color="primary">Primary</button>
<button mat-raised-button color="accent">Accent</button>
<button mat-raised-button color="warn">Warn</button>
<button mat-raised-button disabled="true">Disabled</button>`);

    fabHTML: string = escape(`<button mat-fab color="primary"><mat-icon>grade</mat-icon></button>
...
<button mat-mini-fab disabled="true"><mat-icon>lock</mat-icon></button>`);
    ...
    buttonToggleHTML: string = escape(`<mat-button-toggle-group>
...
<mat-button-toggle-group multiple>
  ...
  <mat-button-toggle>Milk</mat-button-toggle>
    ...
    iconButtonHTML: string = escape(`<button mat-icon-button><mat-icon>menu</mat-icon></button>
