...
export class ComponentsComponent implements OnInit {
    ...
    @ViewChild(CardsComponent, { read: ElementRef })
    ...
    @ViewChild(ListsComponent, { read: ElementRef })
    ...
    @ViewChild(RadioComponent, { read: ElementRef })
    private radio: ElementRef;
    @ViewChild(SliderComponent, { read: ElementRef })
