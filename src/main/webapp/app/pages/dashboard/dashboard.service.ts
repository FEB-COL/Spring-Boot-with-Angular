...
export class DashboardService {
     ...
     */
        ...
        return of({ labels: salesChartDemoLabels(), data: salesChartDemoValues }).pipe(map(values => this.toSalesChartData(values)));
    }
    ...
    getVisits() {
        // Simulating request from local data
        return of({ labels: visitsChartDemoLabels(), data: visitsChartDemoValues }).pipe(map(values => this.toVisitsChartData(values)));
    }
    ...
    getClicks() {
        // Simulating request from local data
        return of({ labels: clicksChartDemoLabels(), data: clicksChartDemoValues }).pipe(map(values => this.toClicksChartData(values)));
    }
