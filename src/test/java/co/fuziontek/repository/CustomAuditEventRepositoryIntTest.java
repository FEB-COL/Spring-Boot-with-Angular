...
import co.fuziontek.config.audit.AuditEventConverter;
import co.fuziontek.domain.PersistentAuditEvent;
...
import static co.fuziontek.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
