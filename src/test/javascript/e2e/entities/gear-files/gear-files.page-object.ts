...
export class GearFilesComponentsPage {
    createButton = element(by.id('jh-create-entity'));
    deleteButtons = element.all(by.css('jhi-gear-files div table .btn-danger'));
    title = element.all(by.css('jhi-gear-files div h2#page-heading span')).first();
...
export class GearFilesUpdatePage {
    pageTitle = element(by.id('jhi-gear-files-heading'));
...
export class GearFilesDeleteDialog {
    private dialogTitle = element(by.id('jhi-delete-gearFiles-heading'));
    private confirmButton = element(by.id('jhi-confirm-delete-gearFiles'));
